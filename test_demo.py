...
@pytest.mark.parametrize("a, b, expected", [(5, 6, 11), (5, -5, 0), (8, 0, 8)])
...
@pytest.mark.parametrize(
    ...
    [(0, r"(?i)zero"), (42, r"(?i)nombre"), (777, "Bingo")],
...
@pytest.mark.parametrize(
    "value, should_raise",
    [(42, True), (0, True), (777, True), (10, False), (648, False), (625, False)],
    ids=[
        "CAS_42_SHOULD",
        "CAS_0_SHOULD",
        "CAS_777_SHOULD",
